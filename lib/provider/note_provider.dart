...
class DbNoteProvider {
  ...
  Future _createDb(Database db) async {
    ...
    await db.execute(
        'CREATE TABLE $tableNotes($columnId INTEGER PRIMARY KEY, $columnNom TEXT, $columnPrenom TEXT, $columnAdresse TEXT, $columnNumero TEXT, $columnUpdated INTEGER)');
    await db
    ...
    await _saveNote(
        ...
        DbNote()
          ..nom.v = 'hmida'
          ..prenom.v = 'khafeelid'
          ..adresse.v = 'rabat rue 45'
          ..numero.v = '+212698856696'
          ..date.v = 1);
    await _saveNote(
        db,
        DbNote()
          ..nom.v = ' hmida'
          ..prenom.v = 'ahmed'
          ..adresse.v = 'casabalnca rue 34'
          ..numero.v = '+212658589969'
          ..date.v = 2);
    _triggerUpdate();
  }
